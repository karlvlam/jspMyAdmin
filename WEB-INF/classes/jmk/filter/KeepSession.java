 ...
 * KeepSession.java
 *
 * Created on 2004年11月20日, 下午 3:02
 */
...
public class KeepSession implements Filter {
    ...
    throws IOException, ServletException {
        if (debug) log("KeepSession:DoBeforeProcessing");
        //
    ...
    throws IOException, ServletException {
        if (debug) log("KeepSession:DoAfterProcessing");
        //
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("KeepSession:Initializing filter");
            }
        }
    }
